 ...
 * |-----------------------------------------------------------------------------------------+
 * |        | H-Q | H-W | H-E | H-R | H-T | H-Y | H-U | H-I | H-O | H-P |     |     |   Del  |
 * |-----------------------------------------------------------------------------------------+
 ...
 */
  [_FN] = KEYMAP(
      ...
      ______, _HP(KC_Q), _HP(KC_W), _HP(KC_E), _HP(KC_R), _HP(KC_T), _HP(KC_Y), _HP(KC_U), _HP(KC_I), _HP(KC_O), _HP(KC_P),    ______, ______, KC_DEL,  \
      ______, _HP(KC_A), _HP(KC_S), _HP(KC_D), _HP(KC_F), _HP(KC_G), KC_LEFT,   KC_DOWN,   KC_UP,     KC_RIGHT,  KC_PSCR, ______, ______,  \
      ______, _HP(KC_Z), _HP(KC_X), _HP(KC_C), _HP(KC_V), _HP(KC_B), _HP(KC_N), _HP(KC_M), KC_VOLD,    KC_VOLU,    ______, KC_INS, ______, \
